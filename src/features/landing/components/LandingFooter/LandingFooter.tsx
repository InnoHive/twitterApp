...
export const LandingFooter:React.FC = () => {
    ...
    return(
        <div className="landing-footer">
            ...
            <p className="footer-link color-gray">Add Info</p>
            ...
            <p className="footer-link color-gray">Brand Resource</p>
            <p className="footer-link color-gray">Advertising</p>
            <p className="footer-link color-gray">Marketing</p>
            <p className="footer-link color-gray">App for Business</p>
            ...
            <p className="footer-copyright color-gray">&#169; 2023</p>
